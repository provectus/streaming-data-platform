...
sed "s/@S3ResourceBucket@/${resourceBucket}/" \
	${PROJECT_DIR}/fds-template.yaml > ${PROJECT_DIR}/fds-template-autogenerated.yaml

$AWS_CLI cloudformation package  \
	--template-file ${PROJECT_DIR}/fds-template-autogenerated.yaml \
